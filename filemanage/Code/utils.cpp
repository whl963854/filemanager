...
QList<QString> Utils::fuzzyMatch(QList<QString>& strs,QString search)
{
    QList<QString>ans;
    for(auto str:strs)
    {
        ...
        if(Utils::matchLetters(str,search))
        {
            ans.push_back(str);
            continue;
        }
...
bool Utils::matchLetters(QString lStr,QString sStr)
{
    lStr=lStr.toLower();
    sStr=sStr.toLower();
    int len1=lStr.size();
...
bool Utils::In(wchar_t start, wchar_t end, wchar_t code)
{
...
QString Utils::GetFirstLetter(const QString &src)
{
    wchar_t wchr{};
    QString firstLetter;
    if(src.size() > 0)
...
QString Utils::GetFirstLetters(const QString &src)
{
...
QString Utils::GetPinyins(const QString &text)
{
    QString pinyins;
    for (int i=0; i<text.length(); i++)
    {
        ...
        {
            QString cha = text.at(i);
            QByteArray arr = cha.toLocal8Bit();
...
QString Utils::GetPinyin(int code)
{
    QString pinyin;
    switch(code)
    {
